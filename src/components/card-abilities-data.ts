...
const UNIT_ABILITY_HINT = [
    {
        "key": "activearmor",
        "propspercentage": "%(damage_amount),%(self_damage_amount)",
                           /*  { damage_amount : 10, self_damage_amount : 15 }*/
    ...
    {
        "key": "antiair",
        "propspercentage": "%(primary_damage_amount_percentage)",
    ...
    {
        "key": "barkboost",
        "propspercentage": "%(health_amount),%(absorb_cap),%(cooldown)",
        "propsname": "§card_name_sapling_plural,§card_name_sapling_plural,§card_name_sapling_plural",
    ...
    {
        "key": "breachingcharge",
        "propspercentage": "%(damage_amount),%(damage_amount_per_energy)",
    ...
    },
    {
        ...
        "propspercentage": "%(damage_amount),%(charge_duration)",
    ...
    {
        "key": "crystalspeed",
        "propspercentage": "%(attack_speed_bonus_percentage),%(cooldown)",
    ...
    {
        "key": "dampingshield",
        "propspercentage": "%(damage_reduction_percentage)",
    ...
    },
    {
        ...
        "propspercentage": "%(energy_cost),%(damage_amount)",
    ...
    },
    {
        ...
        "propspercentage": "%(heal_amount),%(duration)",
    ...
    {
        "key": "debutasteroid",
        "propspercentage": "%(damage_amount)",
        "en": "When this unit enters the battlefield, it deals %(damage_amount) splash damage to all enemies in the impact zone. "
    },
    {
        "key": "debuticyprison",
        "propspercentage": "%(damage_reduction_percentage),%(break_threshold_percentage),%(break_shatter_damage)",
    ...
    {
        "key": "dragonpunch",
        "propspercentage": "%(damage_bonus),%(annihilate_threshold_percentage)",
    ...
    },
    {
        ...
        "propspercentage": "%(energy_cost),%(heal_amount),%(armor_increase)",
    ...
    {
        "key": "enchantmentflux",
        "propspercentage": "%(energy_regeneration_amount),%(energy_regeneration_cooldown),%(energy_regeneration_cap),%(energy_cap_increase)",
    ...
    },
    {
        ...
        "propspercentage": "%(duration),%(attack_speed_bonus_percentage),%(attack_speed_bonus_ranged_percentage),%(heal_amount),%(additional_target_count)",
    ...
    },
    {
        ...
        "propspercentage": "%(duration),%(heal_amount_percentage),%(health_amount)",
    ...
    },
    {
        ...
        "propspercentage": "%(health_amount_percentage),%(health_amount)",
    ...
    },
    {
        ...
        "propspercentage": "%(damage_increase)",
        "en": "Permanent effect: Increases the auto attack damage by %(damage_increase)."
    },
    {
        "key": "enchantmentstrength",
        "propspercentage": "%(energy_cost),%(health_bonus),%(damage_bonus),%(damage_bonus_surefire)",
    ...
    {
        "key": "energyinfusion",
        "propspercentage": "%(energy_per_health),%(health_amount),%(energy_on_enchant)",
    ...
    },
    {
        ...
        "propspercentage": "%(charge_amount),%(cooldown_league_1),%(cooldown_league_2),%(cooldown_league_3),%(cooldown_league_4),%(cooldown_league_5)",
    ...
    {
        "key": "frostnova",
        "propspercentage": "%(energy_cost),%(main_target_damage),%(main_target_splashdamage),%(splash_damage),%(cooldown)",
    ...
    {
        "key": "growsaplings",
        "propspercentage": "%(energy_cost),%(sapling_count)",
    ...
    {
        "key": "inductionrepair",
        "propspercentage": "%(heal_amount_percentage)",
        "en": "Whenever an allied spell is cast nearby this unit heals %(heal_amount_percentage) of its maximum health."
    },
    {
        "key": "innerfirebounce",
        "propspercentage": "%(base_health),%(target_count),%(damage_reduction_percentage)",
    ...
    {
        "key": "intensify",
        "propspercentage": "%(cooldown),%(damage_increase_percentage),%(cap)",
    ...
    {
        "key": "limitedgadget",
        "propspercentage": "%(gadget_limit),%(gadget_limit_exceeded)",
    ...
    {
        "key": "missilelauncher",
        "propspercentage": "%(energy_cost),%(cooldown)",
    ...
    {
        "key": "monarchoffrost",
        "propspercentage": "%(damage_amount),%(heal_amount_percentage)",
    ...
    {
        "key": "nexusbuster1",
        "propspercentage": "%(damage_amount),%(cooldown),%(activation_cooldown)",
    ...
    {
        "key": "permafrost",
        "propspercentage": "%(ally_health_amount),%(enemy_health_reduction_amount)",
    ...
    {
        "key": "rangeaura",
        "propspercentage": "%(range_increase_buildings),%(range_increase_units)",
    ...
    },
    {
        ...
        "propspercentage": "%(reflected_damage_percentage),%(self_damage_amount)",
    ...
    {
        "key": "shieldoverload",
        "propspercentage": "%(duration),%(cooldown)",
    ...
    },
    {
        ...
        "propspercentage": "%(energy_amount),%(health_amount)",
    ...
    },
    {
        ...
        "propspercentage": "%(energy_cost),%(time_to_live)",
    ...
    {
        "key": "soulundertow",
        "propspercentage": "%(target_count),%(energy_amount),%(cooldown)",
    ...
    {
        "key": "soulvortex",
        "propspercentage": "%(health_threshold),%(cooldown)",
    ...
    {
        "key": "splinter",
        "propspercentage": "%(damage_threshold),%(cooldown)",
    ...
    {
        "key": "steadyaim",
        "propspercentage": "%(range_increase),%(duration)",
    ...
    {
        "key": "summonsaplings",
        "propspercentage": "%(energy_cost),%(sapling_amount)",
        "propsname": "§card_name_sapling_plural",
        "en": "Consumes %(energy_cost) energy to summon %(sapling_amount) <span class=\"keyword sapling\">§card_name_sapling_plural</span>."
    },
    {
        "key": "supreme",
        "propspercentage": "%(module_gain),%(module_cap),%(health_amount),%(armor_level_unarmored),%(armor_level_light),%(armor_level_medium),%(armor_level_heavy)",
        "propsname": "§armortype_atunarmored,§armortype_atlight,§armortype_atmedium,§armortype_atheavy",
    ...
    {
        "key": "teleportstrike",
        "propspercentage": "%(energy_cost),%(damage_amount),%(cooldown)",
    ...
    {
        "key": "warminglight",
        "propspercentage": "%(heal_amount)",
        "en": "Attacks heal allied units in the impact zone by %(heal_amount) health."
    },
    {
        "key": "wavegun",
        "propspercentage": "%(energy_cost),%(health_threshold),%(damage_amount)",
    ...
    {
        "key": "wipe",
        "propspercentage": "%(health_threshold),%(damage_reduction_percentage)",
