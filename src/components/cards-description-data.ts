export const CARD_DESCRIPTIONS = [
    {
        "key": "card_description_ammorefill",
        "propspercentage": "%(energy_amount_stage_1_percentage),%(energy_amount_stage_2_percentage),%(energy_amount_stage_3_percentage),%(energy_amount_legendary_percentage)",
    ...
    {
        "key": "card_description_cataclysm",
    ...
    {
        "key": "card_description_earthquake",
        "propspercentage": "%(wave_cooldown),%(wave_count),%(damage_amount)",
    ...
    {
        "key": "card_description_EchoesOfTheFuture",
        "propspercentage": "%(duration),%(duration)",
        "entext": "Doubles your income for the next %(duration) seconds. Afterwards you don't get any income for %(duration) seconds."
    },
    {
        "key": "card_description_energyrift",
        "propspercentage": "%(damage_amount),%(duration)",
    ...
    {
        "key": "card_description_entanglingroots",
        "propspercentage": "%(target_count)",
        "entext": "<span class=\"keyword rooted\">Roots</span> up to %(target_count) enemy units in target area."
    },
    {
        "key": "card_description_evolveoracle",
        "propspercentage": "%(initial_health_percentage)",
        "propsname": "§card_name_sapling,§card_name_oracle",
    ...
    {
        "key": "card_description_evolvethistle",
        "propspercentage": "%(target_count)",
    ...
    {
        "key": "card_description_factoryreset",
        "propspercentage": "%(target_count)",
    ...
    {
        "key": "card_description_fluxfield",
        "propspercentage": "%(charge_amount)",
    ...
    {
        "key": "card_description_giantgrowth",
        "entext": "Target allied unit gains <span class=\"keyword enchantment\">Enchantment</span>: Growth."
    },
    {
        "key": "card_description_hailofarrows",
        "propspercentage": "%(initial_wave_count),%(damage_amount)",
    ...
    {
        "key": "card_description_healinggarden",
        "propspercentage": "%(energy_amount),%(energy_cooldown),%(charge_amount)",
    ...
    {
        "key": "card_description_inversegravity",
        "propspercentage": "%(target_count)",
    ...
    {
        "key": "card_description_lightpulse",
        "propspercentage": "%(target_count_stun),%(target_count_blind)",
    ...
    {
        "key": "card_description_ontheedge",
        "propspercentage": "%(range_reduction),%(charge_amount)",
        "propsname": "§unitability_name_enchantmentgrievouswounds",
    ...
    {
        "key": "card_description_orbitalstrike",
        "propspercentage": "%(primary_damage_amount),%(primary_damage_cooldown),%(splash_damage_amount),%(splash_damage_cooldown),%(duration)",
    ...
    {
        "key": "card_description_relocate",
        "propspercentage": "%(target_count),%(cooldown),%(heal_stage_1),%(energy_stage_1),%(heal_stage_2),%(energy_stage_2),%(heal_stage_3),%(energy_stage_3)",
    ...
    {
        "key": "card_description_ripoutsoul",
        "propspercentage": "%(target_count),%(damage_amount_percentage)",
    ...
    {
        "key": "card_description_saplingcharge",
        "propspercentage": "%(initial_sapling_amount),%(wave_sapling_amount),%(wave_count)",
        "propsname": "§card_name_sapling_plural,§card_name_sapling_plural",
    ...
    {
        "key": "card_description_shatterice",
        "propspercentage": "%(damage_amount),%(damage_amount_buildings)",
    ...
    {
        "key": "card_description_shieldsup",
        "propspercentage": "%(target_count)",
        "entext": "Up to %(target_count) allied units in target area gain a <span class=\"keyword shieldblock\">shieldblock</span>."
    },
    {
        "key": "card_description_solarflare",
        "propspercentage": "%(primary_heal_amount),%(splash_heal_amount),%(duration)",
    ...
    {
        "key": "card_description_StoneCircle",
        "propspercentage": "%(damage_reduction_percentage),%(charge_amount)",
        "propsname": "§unitability_name_enchantmentstonefist",
    ...
    {
        "key": "card_description_surgeoflight",
        "propspercentage": "%(heal_amount),%(counter_gained_amount),%(damage_amount)",
